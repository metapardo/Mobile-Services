...
const BUSINESS_TABLES = [
  ...
  "employee_splits",
  "settings",
  // PRD_Mobull_Appointment_Optimizer_v1.0.md FR-21a. NOTE: "route_cache" is
  // deliberately NOT in this list — it's the one table in this schema without RLS,
  // see `../src/schema/route-cache.ts`'s doc comment.
  "rate_limit_counters",
  // PRD_Mobull_Weather_Coverage.md FR-9. NOTE: "weather_cache" is deliberately NOT in
  // this list either — same shared-cache exception as "route_cache" above, see
  // `../src/schema/weather-cache.ts`'s doc comment.
];
