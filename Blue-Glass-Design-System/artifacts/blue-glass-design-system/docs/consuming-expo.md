# Consuming Blue Glass Design System in Expo apps

Read `artifacts/blue-glass-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/blue-glass-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/blue-glass-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/blue-glass-design-system/lib/native-theme";
import { useColors } from "@workspace/blue-glass-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/blue-glass-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/blue-glass-design-system/components/native/badge";
import { Button } from "@workspace/blue-glass-design-system/components/native/button";
import { Card } from "@workspace/blue-glass-design-system/components/native/card";
```
...
Import and render
`@workspace/blue-glass-design-system/components/native/button`, then run Expo
