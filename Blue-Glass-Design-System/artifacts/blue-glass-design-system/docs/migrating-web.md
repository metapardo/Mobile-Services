# Migrating web UI to Blue Glass Design System

Read `artifacts/blue-glass-design-system/docs/AGENTS.md` and
`artifacts/blue-glass-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/blue-glass-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/blue-glass-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/blue-glass-design-system/hooks/use-toast`
