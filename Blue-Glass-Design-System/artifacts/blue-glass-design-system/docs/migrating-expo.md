# Migrating Expo UI to Blue Glass Design System

Read `artifacts/blue-glass-design-system/docs/AGENTS.md` and
`artifacts/blue-glass-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/blue-glass-design-system/lib/native-theme` and
  `@workspace/blue-glass-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/blue-glass-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/blue-glass-design-system` and retains only
