# Consuming Blue Glass Design System in web apps

Read `artifacts/blue-glass-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/blue-glass-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/blue-glass-design-system/styles.css";
```
...
`node_modules/@workspace/blue-glass-design-system/src/components` to `content`.
...
import {
  toast,
  useToast,
} from "@workspace/blue-glass-design-system/hooks/use-toast";
```
...
`@workspace/blue-glass-design-system/components/ui/button`. Run the app's typecheck
