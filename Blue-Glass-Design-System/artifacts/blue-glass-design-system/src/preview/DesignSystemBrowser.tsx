...
export function DesignSystemBrowser() {
  ...
  return (
    <div className="min-h-screen bg-background/75 text-foreground md:grid md:grid-cols-[272px_minmax(0,1fr)]">
      <aside className="glass-panel-strong border-b md:sticky md:top-0 md:flex md:h-screen md:flex-col md:border-b-0 md:border-r">
        <div className="border-b px-5 py-5">
          <div className="flex items-center gap-3">
            <span className="blue-glow grid size-9 place-items-center rounded-xl bg-primary text-sm font-black text-primary-foreground">
              B
            </span>
            <div>
              <p className="text-sm font-semibold">{DESIGN_SYSTEM.title}</p>
              <p className="mt-0.5 text-xs text-muted-foreground">Living design system</p>
            </div>
          </div>
        </div>
