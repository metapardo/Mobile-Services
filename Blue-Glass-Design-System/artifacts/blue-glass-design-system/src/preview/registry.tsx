...
import { PricingExamplePage } from './applied';
...
export const DESIGN_SYSTEM = {
  title: 'Blue Glass',
  description:
    'A dark-first product language built from electric blue focus, deep ocean surfaces, and restrained liquid-glass depth.',
} as const;
    ...
    entries: [
      {
        ...
        description: 'A Flora-inspired plan comparison using Blue Glass hierarchy and surfaces.',
